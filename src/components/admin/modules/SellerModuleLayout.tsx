import { Store, Users, FileText, ShoppingCart, Package, Wallet, Zap, Star, Upload, Tag, RotateCcw, XCircle, DollarSign, CreditCard, MessageSquare } from "lucide-react";
...
const SellerModuleLayout = () => {
  ...
  const navItems: ModuleNavItem[] = [
    ...
    { name: "Deposits", href: "/admin/module/sellers/deposits", icon: CreditCard, badge: counts.pendingSellerDeposits },
    ...
    { name: "Chat Shortcuts", href: "/admin/module/sellers/chat-shortcuts", icon: MessageSquare },
  ];
